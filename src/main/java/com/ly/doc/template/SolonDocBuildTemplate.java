 ...
 */
public class SolonDocBuildTemplate implements IDocBuildTemplate<ApiDoc>, IWebSocketDocBuildTemplate<WebSocketDoc>,
	...
	public FrameworkAnnotations registeredAnnotations() {
		...
		MappingAnnotation requestMappingAnnotation = MappingAnnotation.builder()
			...
			.setPathProps(DocAnnotationConstants.VALUE_PROP, DocAnnotationConstants.NAME_PROP,
